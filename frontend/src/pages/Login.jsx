...
export default function Login() {
  ...
  const appName = settings.app_name || "Nexus Storage";
  const tagline = settings.tagline || "All your storage, one clean workspace.";
      ...
      <div className="hidden lg:flex flex-1 relative items-center justify-center p-16 bg-gradient-to-br from-blue-600 to-indigo-700 overflow-hidden">
        ...
        <div className="relative max-w-md text-white">
          <div className="flex items-center gap-2.5 mb-10">
            ...
            <span className="font-display font-bold text-xl tracking-tight">{appName}</span>
          </div>
      ...
      <div className="w-full lg:w-[480px] flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-2.5 mb-10">
            ...
            <span className="font-display font-bold text-xl tracking-tight text-gray-900">{appName}</span>
          </div>
